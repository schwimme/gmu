...
int main(int argc, char* argv[])
{
	...
	s_test tests[TEST_COUNT] = {{16,1024,1024,{16,16}, " Work group: 16x16\n Matrix a: 16x1024\n Matrix b: 1024x16\n Matrix c: 1024x1024"},
								{32,1024,1024,{16,16}, " Work group: 16x16\n Matrix a: 32x1024\n Matrix b: 1024x32\n Matrix c: 1024x1024"},
								{33,1024,1024,{16,16}, " Work group: 16x16\n Matrix a: 33x1024\n Matrix b: 1024x33\n Matrix c: 1024x1024"},
								{33,1025,1023,{16,16}, " Work group: 16x16\n Matrix a: 33x1025\n Matrix b: 1023x33\n Matrix c: 1023x1025"}};		
	...
	cl::make_kernel<cl::Buffer&, cl::Buffer&, cl::Buffer&, cl_int&, cl_int&, cl_int&, cl::LocalSpaceArg&, cl::LocalSpaceArg&> matrix_mul_local = cl::make_kernel<cl::Buffer&, cl::Buffer&, cl::Buffer&, cl_int&, cl_int&, cl_int&, cl::LocalSpaceArg&, cl::LocalSpaceArg&>(program, "matrix_mul_local", &err_msg);
